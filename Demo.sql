...
GO
--DEMO CO LOI
--INSERT INTO KHACHHANG VALUES('0900000001', N'Nguyen Van A', '1990-1-15', '2023-01-01', '2024-01-01', N'KIM CƯƠNG')
--EXEC SP_TANGPHIEUMUAHANG;
--EXEC SP_XOATAIKHOAN '0900000001', N'Nguyen Van A', '1990-01-15';
...
--INSERT INTO KHACHHANG VALUES('0900000004', N'Pham Van D', '1988-07-19', '2020-11-30', '2023-12-29', N'BẠC')
--SELECT* FROM LSMUAHANG WHERE SODIENTHOAI = '0900000004'
--INSERT INTO LSMUAHANG VALUES ('0900000004', '2024-04-10 16:00:00', 50000000)
--EXEC SP_CAPNHATKHTT
--SELECT* FROM KHACHHANG
...
--SELECT* FROM KHACHHANG
--EXEC SP_TAOTAIKHOAN '0965422252', N'Lê Nguyễn Yến Vy', '2004-07-05'
--SELECT* FROM KHACHHANG
...
--SELECT* FROM KHACHHANG WHERE SODIENTHOAI = '0965422252'
--EXEC SP_SUATHONGTINLIENLAC '0965422252', N'Lê Nguyễn Yến Vy', '0973488548', N'Lê Cam', '2004-07-05'
--SELECT* FROM KHACHHANG WHERE SODIENTHOAI = '0973488548'
...
--SELECT* FROM KHACHHANG WHERE SODIENTHOAI = '0973488548'
--EXEC SP_XOATAIKHOAN '0973488548', N'Lê Cam', '2004-07-05'
--SELECT* FROM KHACHHANG WHERE SODIENTHOAI = '0973488548'
...
END;
GO
--SELECT* FROM PHIEUMUAHANG WHERE MAPHIEUMUAHANG = 'PMH00001'
--EXEC SP_XOAPHIEUMUAHANG 'PMH00001'
--SELECT* FROM PHIEUMUAHANG WHERE MAPHIEUMUAHANG = 'PMH00001'
...
EXEC SP_TIM_KHUYEN_MAI_TOT_NHAT '5'
EXEC SP_THEM_KHUYEN_MAI '30', 1, NULL, '1', 50,'2024-12-28','2024-12-30', 200, NULL
-- TÌNH HUỐNG 2
INSERT INTO KHACHHANG VALUES('0900000001', N'Nguyen Van A', '1990-1-15', '2023-01-01', '2024-01-01', N'KIM CƯƠNG')
EXEC SP_TANGPHIEUMUAHANG;
...
-- TÌNH HUỐNG 3
EXEC SP_TIM_KHUYEN_MAI_TOT_NHAT '5'
EXEC SP_SUATHONGTINLIENLAC '0900000005', N'Do Thi E','0982277122', N'Do Thi E', '1995-04-10';
