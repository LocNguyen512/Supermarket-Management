...
EXEC SP_THEM_KHUYEN_MAI '17', 1, NULL, '3', 50,'2024-12-28','2024-12-30', 20, N'VÀNG'
...
GO
CREATE PROC SP_TIM_UU_DAI_TOT_NHAT @DONHANGID NVARCHAR(50)
AS
BEGIN
	IF NOT EXISTS(SELECT 1 FROM DONHANG AS DH WHERE DH.DONHANGID=@DONHANGID)
		BEGIN
			RAISERROR(N'Không tìm thấy mã đơn hàng',16,1)
		END
	DECLARE @SDT CHAR(10)
